...
```
Your thoughts...
I am a PhD student in nutrition, so from my perspective, one example of how value systems are embedded in data systems can be seen in the way race and ethnicity are categorized in questionnaires and databases. In addition, this issue is also reflected in how race and ethnicity are categorized in much of the data analysis we conduct.Unintentionally, these practices reflect underlying value systems in which Western populations are treated as the default, and convenience is prioritized over inclusivity.

Many standardized data collection tools in nutrition are structured around western-centric classifications, where categories such as “White,” “Black,” and “Hispanic” are explicitly listed, while Asian populations are often grouped into “Other.” In addition, food categorizations in nutrition surveys are also heavily based on western diets, which makes it more difficult for some individuals to respond accurately. Furthermore, after collecting the questionnaires, researchers must input the data into food composition databases. These databases are also heavily based on western diets, making data entry more challenging when working with non-western foods. Due to the lack of appropriate options, many items must be estimated or approximated, which can lead to inaccuracies in the data.

Together, these factors can obscure the substantial heterogeneity within Asian populations in terms of dietary patterns and disease risk. As a result, these data systems may unintentionally reinforce inequality by limiting the visibility of specific groups and reducing the accuracy and relevance of findings for these populations. Furthermore, because of how surveys are structured, Asian participants may find them more time-consuming or difficult to complete, which can lead to lower response rates. Lower participation results in fewer data points, reducing statistical power and increasing the likelihood that Asian populations are categorized as “other”. This, in turn, contributes to inadequate representation, gaps in knowledge, and reduced inclusivity in nutrition research. Although there have been  improvements over past decades, I think further efforts are still needed to enhance inclusivity in data systems.
